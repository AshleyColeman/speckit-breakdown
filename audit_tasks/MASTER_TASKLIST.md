...
- [x] 018: [Improve typing in UpsertService and BootstrapSummary](./018_fix_typing_in_upsertservice_and_bootstrapsummary.md)
- [x] 019: [Align hard rules with reality or enforce them](./019_align_hard_rules_with_codebase_or_enforce_limits.md)
- [x] 020: [Integrate (or remove) unused safety mechanisms: locking + rollback](./020_integrate_or_remove_unused_safety_mechanisms_locking_and_rollback.md)
