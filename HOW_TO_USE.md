...
├── SETUP_AS_REPO.md                   # GitHub setup instructions
├── LICENSE                            # MIT license
...
~/speckit-breakdown/install-local.sh
```
...
```bash
# Follow SETUP_AS_REPO.md instructions
# Publish to GitHub
...
Read: `/tmp/speckit-breakdown/SETUP_AS_REPO.md`
