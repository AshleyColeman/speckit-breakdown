...
- **Local testing (for you as author)** – from `install-local.sh` (see `GET_STARTED.md` / `HOW_TO_USE.md`):
...
- **Root docs**
  ...
  - `GET_STARTED.md` / `HOW_TO_USE.md` – local prototype vs shareable tool usage
  - `INSTALLATION_GUIDE.md` / `SETUP_AS_REPO.md` – installation + publishing
  - `LICENSE`, `VERSION`
